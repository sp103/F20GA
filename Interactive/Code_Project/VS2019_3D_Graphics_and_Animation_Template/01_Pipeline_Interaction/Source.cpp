...
void startup() {
	...
	desk.LoadModel("desk.obj");
	lamp.LoadModel("lamp.obj");
	cabinet.LoadModel("cabinet.obj");
	drawer.LoadModel("drawer.obj");
	drawer1.LoadModel("drawer1.obj");
	drawer2.LoadModel("drawer2.obj");
	phone.LoadModel("phone.obj");
	room.LoadModel("room.obj");
	coat_stand.LoadModel("coat_stand.obj");
	...
	modelPosition = glm::vec3(0.0f, -2.0f, 0.0f);
	modelRotation = glm::vec3(0.0f, 90.0f, 0.0f);
